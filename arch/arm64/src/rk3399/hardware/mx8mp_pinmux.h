...
#define IOMUXC_PMUGRF_GPIO1B_IO07_I2C0PMU_SCL GRF_GPIO3A_IOMUX_ADDR, 0b00, 0x00000000, 0x0, 0x00000000
...
#define IOMUXC_GRF_GPIO4D_IO01_PCIE_CLKREQNB
#define IOMUXC_GRF_GPIO4D_IO02_DP_HOTPLUG 
